...
import com.newrelic.automotive.servicedefinition.controller.ChkdgrtnController;

@RunWith(SpringJUnit4ClassRunner.class)
@ContextConfiguration(classes = {WebConfig.class})
@WebAppConfiguration
public class ChkdgrtnControllerTest {

		
	@InjectMocks
	public ChkdgrtnController chkdgrtnController;
	...
	public void setup() throws Exception {
		...
		mockMvc = MockMvcBuilders.standaloneSetup(chkdgrtnController).build();		
	}
		
				@Test
				public void test_chkdgrtn() throws Exception {
