...
directives.factory('localize', ['$http', '$rootScope', '$window', '$filter', function ($http, $rootScope, $window, $filter) {
        var localize = {
    ...
    .filter('i18n', ['localize', function (localize) {
        function localiseFilter (input) {
            return localize.getLocalizedString(input);
        };
        
        localiseFilter.$stateful = true;
        
        return localiseFilter;
    }])
