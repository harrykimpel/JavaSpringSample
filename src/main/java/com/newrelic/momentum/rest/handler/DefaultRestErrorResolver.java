 ...
 */
package com.newrelic.momentum.rest.handler;
...
public class DefaultRestErrorResolver implements RestErrorResolver,
	...
	public Map<String, RestError> toRestErrors(Map<String, String> smap) {
	...
	private static int getInt(String key, String value) {
		try {
			...
			log.error("The value must be an integer :", iae);
			return 0;
		}
	}
}
